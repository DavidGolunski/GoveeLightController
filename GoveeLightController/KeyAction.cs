...
namespace GoveeLightController {
    [PluginActionId("com.davidgolunski.goveelightcontroller.keyaction")]
    ...
    public class KeyAction : KeypadBase {
        ...
        public override void KeyPressed(KeyPayload payload) {
            ...
            GoveeDeviceController.Instance.TurnOn();
            GoveeDeviceController.Instance.SetColor(new Color(255, 255, 0));
        }
